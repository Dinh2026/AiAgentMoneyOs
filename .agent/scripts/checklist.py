#!/usr/bin/env python3
"""
Master Checklist Runner - Ai Agent Money OS
==========================================
...
def print_error(text: str):
    print(f"{Colors.RED}âŒ {text}{Colors.ENDC}")
...
def print_summary(results: List[dict]):
    ...
    print(f"{Colors.RED}âŒ Failed: {failed_count}{Colors.ENDC}")
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Ai Agent Money OS validation checklist",
...
Examples:
  ...
  python scripts/checklist.py . --url http://localhost:3000  # Include performance
    ...
    print_header("ðŸš€ AI AGENT MONEY OS - MASTER CHECKLIST")
