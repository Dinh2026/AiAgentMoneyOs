...
> Orchestration through Ai Agent Money OS's built-in Agent Tool

## Overview

This skill enables coordinating multiple specialized agents through Ai Agent Money OS's native agent system. Unlike external scripts, this approach keeps all orchestration within Ai Agent Money OS's control.
...
## Ai Agent Money OS Built-in Agents
