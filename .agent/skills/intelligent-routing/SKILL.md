...
| **Offer / Market**  | "offer", "pricing", "niche", "competitor", "market research" | `01-offer-agent`                | ✅ YES       |
| **Funnel / Content** | "funnel", "lead magnet", "content calendar", "traffic" | `02-attraction-agent`             | ✅ YES       |
| **Sales / Copy**    | "sales page", "copy", "VSL", "email sequence", "objection" | `03-conversion-agent`         | ✅ YES       |
| **Payment / Delivery** | "VietQR", "SePay", "Telegram notification", "delivery automation" | `04-deliver-agent` | ✅ YES       |
| **Revenue / Analytics** | "revenue", "analytics", "conversion rate", "optimize LTV" | `05-insights-agent`      | ✅ YES       |
...
| **Offer**       | offer, niche, pricing, value stack, competitor | `01-offer-agent`     |
| **Attraction**  | funnel, lead magnet, content, traffic      | `02-attraction-agent`   |
| **Conversion**  | sales page, copywriting, VSL, email, objection | `03-conversion-agent` |
| **Delivery**    | payment, VietQR, SePay, delivery, Telegram | `04-deliver-agent`      |
| **Insights**    | revenue, analytics, KPI, conversion rate, LTV | `05-insights-agent`  |
